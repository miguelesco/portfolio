...
function CardsGeneration() {
  ...
  const content = [
    {
      ...
      sourceURL: 'https://github.com/miguelesco/portfolio',
      liveURL: 'https://miguelesco.github.io/portfolio/',
  ...
  const renderCardContent = () => {
    ...
    cardChild.forEach((child, i) => {
      const {
        cardImage, cardTitle, categories, buttonContainer,
      } = child;
